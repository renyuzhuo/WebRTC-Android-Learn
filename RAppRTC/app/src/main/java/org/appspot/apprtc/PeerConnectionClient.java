...
public class PeerConnectionClient {
    ...
    public static class PeerConnectionParameters {
        ...
        public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback, boolean tracing,
                                        ...
                                        boolean disableBuiltInAGC, boolean disableBuiltInNS, boolean enableLevelControl, boolean screenOrCamera) {
    ...
    public void createPeerConnectionFactory(final Context context, final Activity activity,
