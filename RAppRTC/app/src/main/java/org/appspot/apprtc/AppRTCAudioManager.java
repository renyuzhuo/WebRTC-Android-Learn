...
public class AppRTCAudioManager {
    ...
    static AppRTCAudioManager create(Context context,
        ...
        rlog.d("创建AppRTCAudioManager，管理所有音频相关内容");
    ...
    private AppRTCAudioManager(Context context,
        ...
        rlog.d("音频采集设备：" + defaultAudioDevice);
